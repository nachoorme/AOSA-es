...
\title{La Arquitectura de las Aplicaciones de Código Libre}
\date{}
...
{ \renewcommand{\chapterauthor}{#3} \chapter{#1} \label{#2} 
   \addtocontents{toc}{\hspace{1cm}\textit{\textsf{por \chapterauthor}}\protect\par} } {  }

\newenvironment{aosachaptertoc}[4]
{ \renewcommand{\chapterauthor}{#3}
  \renewcommand{\chapterauthortoc}{#4}
  \chapter{#1} \label{#2} 
  \addtocontents{toc}{\hspace{1cm}\textit{\textsf{por \chapterauthortoc}}\protect\par} } {  }
...
\newcommand{\aosachapref}[1]{Capítulo~\ref{#1}}
\newcommand{\aosafigref}[1]{Figura~\ref{#1}}
\newcommand{\aosasecref}[1]{Sección~\ref{#1}}
\newcommand{\aosatblref}[1]{Tabla~\ref{#1}}
...
\titleformat{\chapter}
  ...
  {\vspace{-2cm} \hfill \Large Capítulo \hspace{-0.2cm} \Huge \thechapter} 
