...
filosofía simplifica la gestión de aplicaciones: cada aplicación es un ``dispositivo''
...
beneficiarán cuando es actualiza.  Por ejemplo, una revisión de seguridad en una
